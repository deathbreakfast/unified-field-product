...
//!         Box::pin(async move {
//!             let users = lepton::generated::User::query_used(valence, valence::use_!("query User in src/search_sources/mod.rs; Valence persistence for this feature path; typed store; visible to session actor / service path."))
